...
const get_service_file_text = (id) => {
  ...
  return `package com.github.warren_bank.barejs_frontend.services.fork;

public class BareService_${ padded_id } extends AbstractBareService {
...
const relative_file_path = '../../../android-studio-project/BareJS-Frontend/src/main/java/com/github/warren_bank/barejs_frontend/services/fork'
const absolute_file_path = path.resolve(relative_file_path)

const get_service_file_path = (id) => {
  const padded_id = get_padded_id(id)

  return path.join(absolute_file_path, `BareService_${ padded_id }.java`)
}
