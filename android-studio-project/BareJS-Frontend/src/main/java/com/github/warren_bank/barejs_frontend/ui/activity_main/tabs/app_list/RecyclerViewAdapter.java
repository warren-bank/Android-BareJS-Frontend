package com.github.warren_bank.barejs_frontend.ui.activity_main.tabs.app_list;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewHolder> implements ItemMoveCallback.OnRowEventListener {
  ...
  public interface ColorPalette {
    int getColorOnRowSelected(BareJsApp listItem);
    int getColorOnRowClear(BareJsApp listItem);
  }
  ...
  public RecyclerViewAdapter(ArrayList<BareJsApp> listItems, View.OnCreateContextMenuListener onCreateContextMenuListener, ItemMoveCallback.OnDragListener onDragListener, ColorPalette colorPalette) {
  ...
  public void onBindViewHolder(RecyclerViewHolder holder, int position) {
    BareJsApp listItem = listItems.get(position);
  ...
  public void onRowMoved(int fromPosition, int toPosition) {
    ...
    BareJsApp.movePosition(listItems, fromPosition, toPosition);
  ...
  public void onRowSelected(RecyclerViewHolder holder) {
    if (colorPalette != null) {
      BareJsApp listItem = getListItemFromHolder(holder);
  ...
  private BareJsApp getListItemFromHolder(RecyclerViewHolder holder) {
    int position = holder.getAdapterPosition();
    BareJsApp listItem = listItems.get(position);
    return listItem;
  }
