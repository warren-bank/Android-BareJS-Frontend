package com.github.warren_bank.barejs_frontend.ui.activity_main;

import com.github.warren_bank.barejs_frontend.R;
import com.github.warren_bank.barejs_frontend.helpers.RuntimePermissionsMgr;
import com.github.warren_bank.barejs_frontend.helpers.UI;
import com.github.warren_bank.barejs_frontend.ui.activity_main.tabs.AbstractTabFragment;
...
public class MainActivity extends AppCompatActivity implements RuntimePermissionsMgr.OnRuntimePermissionsListener {
  ...
  //   * required by bare.js  to read JS files
  // WRITE_EXTERNAL_STORAGE
  //   * required by frontend to export data backups
  //   * required by bare.js  to write to the filesystem
  // ---------------------------------------------------------------------------------------------
  // normal:
  // ---------------------------------------------------------------------------------------------
  // FOREGROUND_SERVICE
  //   * required by frontend to run bare.js daemons
  // WAKE_LOCK
  //   * required by frontend to prevent resources from going into low power state while bare.js daemons are running
  // INTERNET
  //   * required by bare.js  to do networking; as either a client or server
  // ---------------------------------------------------------------------------------------------
  @Override
